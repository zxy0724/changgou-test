package zxy.changgou.seckill.service.impl;

import com.alibaba.fastjson.JSON;
import zxy.changgou.seckill.config.ConfirmMessageSender;
import zxy.changgou.seckill.config.RabbitMQConfig;
import zxy.changgou.seckill.dao.SeckillOrderMapper;
import zxy.changgou.seckill.pojo.SeckillGoods;
import zxy.changgou.seckill.pojo.SeckillOrder;
import zxy.changgou.seckill.service.SecKillOrderService;
...
public class SecKillOrderServiceImpl implements SecKillOrderService {
    ...
    public boolean add(Long id, String time, String username) {
        ...
        //decrement:减 increment:加     ->   （业务复杂可以使用lua脚本） Lua脚本语言
